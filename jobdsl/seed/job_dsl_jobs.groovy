...
//                def repo = config.parameters.action.SeleneseTester.repoAddress
                def b = config.parameters.action.SeleneseTester.reference ? config.parameters.action.SeleneseTester.reference : 'master'
