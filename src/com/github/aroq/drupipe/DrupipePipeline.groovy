...
//                    context.utils = utils
                    ...
                    def configParams = script.drupipeAction([action: 'Config.perform', params: [jenkinsParams: params, interpolate: 0]], context.clone() << params, this)
    ...
    def executePipelineActionList(actions, context) {
        ...
        try {
            for (action in actionList) {
                ...
                utils.debugLog(context, actionResult, 'executePipelineActionList actionResult', [debugMode: 'json'], [], true)
...
//                    context = utils.serializeAndDeserialize(context)
                ...
                utils.debugLog(context, context, 'executePipelineActionList CONTEXT', [:], [], true)
            }
            context
        }
        catch (err) {
